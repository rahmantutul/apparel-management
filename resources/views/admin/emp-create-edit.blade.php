        ...
        <form method="POST" action="{{ isset($employee) ? route('employees.update', $employee->id) : route('employees.store') }}" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="emp_id" name="emp_id" 
                                    value="{{ old('emp_id', $employee->emp_id ?? '') }}" placeholder="EMP-001">
                            </div>
                    ...
                    <div class="card form-card">
                        <div class="card-header">
                            <h5><i class="fas fa-address-book mr-2"></i> Contact Information</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card form-card">
                        <div class="card-header">
                            <h5><i class="fas fa-file-alt mr-2"></i> Documents & Images</h5>
                        </div>
                        <div class="card-body">
                            <div class="form-group">
